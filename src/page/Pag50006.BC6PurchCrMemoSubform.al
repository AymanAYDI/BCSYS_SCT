page 50006 "BC6 Purch. Cr. Memo Subform"
{
    ...
    AutoSplitKey = true;
    Caption = 'Purch. Invoice Subform', Comment = 'FRA="Sous-form. avoir achat"';
    DelayedInsert = true;
        ...
        area(processing)
        {
            group("Fonction&s")
            {
                ...
                action(GetReturnShipmentLines)
                {
                    ...
                    Caption = 'Get Return &Shipment Lines', Comment = 'FRA="Extraire lignes e&xpédition retour"';
                    Ellipsis = true;
            ...
            group("&Ligne")
            {
                ...
                action("Ite&m Card")
                {
                    Caption = 'Ite&m Card', Comment = 'FRA="Fiche &article"';
                    ApplicationArea = All;
                    Image = item;
    ...
    var
        ...
        PurchInfoPaneMgt: Codeunit "BC6_FunctionsMgt";
