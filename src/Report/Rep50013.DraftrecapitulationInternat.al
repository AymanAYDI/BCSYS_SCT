report 50013 "Draft recapitulation Internat."
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/DraftrecapitulationInternat.rdl';

    Caption = 'Draft recapitulation', Comment = 'FRA="Récapitulatif de virement international"';
