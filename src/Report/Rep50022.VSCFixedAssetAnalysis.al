report 50022 "BC6_VSC Fixed Asset - Analysis"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/VSCFixedAssetAnalysis.rdl';
    Caption = 'Fixed Asset - Analysis', Comment = 'FRA="Immobilisations - Analyse"';
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                field("Lois d'amortissement"; DeprBookCode)
                {
                    Caption = 'Lois d''amortissement';
                    ApplicationArea = All;
                }
                ...
                field("Afficher l'en-tête"; Gbool_AfficherEnTete)
                {
                    Caption = 'Afficher l''en-tête';
                    ApplicationArea = All;
                }
            }
        }
