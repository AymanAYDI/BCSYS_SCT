report 50053 "Consult general accounts (FNP)"
{
    // CREATION JX-AUD du 04/10/2010
    // CONSULTATION DES COMPTES GENERAUX 408*
    // 
    // //JX-AUD du 13/05/2013
    // //Agrandissement logo
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/ConsultgeneralaccountsFNP.rdl';

    Caption = 'Consult general accounts (FNP)', Comment = 'FRA="Consultation des comptes généraux (FNP)"';
    ...
    dataset
    {
        dataitem(DataItem1000000003; Integer)
        {
            ...
            column(CONSULTATION_OF_GENERAL_ACCOUNTS__FNP_Caption; CONSULTATION_OF_GENERAL_ACCOUNTS__FNP_CaptionLbl)
            {
            }
        ...
        {
            DataItemTableView = SORTING("BC6_Vendor No.");
            ...
            column(G_L_Entry__G_L_Entry___Vendor_No__; "G/L Entry"."BC6_Vendor No.")
            {
            }
    ...
    var
        ...
        CONSULTATION_OF_GENERAL_ACCOUNTS__FNP_CaptionLbl: Label 'CONSULTATION OF GENERAL ACCOUNTS (FNP)', Comment = 'FRA="CONSULTATION DES COMPTES GENERAUX (FNP)"';
