report 50002 "BC6_Facture Achat"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/FactureAchat.rdl';
    ...
    dataset
    {
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            RequestFilterHeading = 'Posted Purchase Invoice', Comment = 'FRA="Facture achat enregistrée"';
            ...
            dataitem(CopyLoop; 2000000026)
            {
                ...
                dataitem(PageLoop; 2000000026)
                {
                    ...
                    column(OrderDate_PurchHeader; FORMAT("Purch. Inv. Header"."Order Date"))
                    {
                    }
            ...
            begin
                ...
                FormatAddr.PurchInvBuyFrom(BuyFromAddr, "Purch. Inv. Header");
    ...
    labels
    {
        ...
        Title = 'ORDER', Comment = 'FRA="FACTURE"';
    ...
    var
        ...
        PaymentMethodCaptionLbl: Label 'Payment Method', Comment = 'FRA="Mode de réglement"';
        ...
        PostingDateCaptionLbl: Label 'Posting Date', Comment = 'FRA="Date Facture"';
