report 50052 "Consult general accounts (FAE)"
{
    // CREATION JX-AUD du 04/10/2010
    // CONSULTATION DES COMPTES GENERAUX 418*
    // 
    // //JX-AUD du 13/05/2013
    // //Agrandissement logo
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/ConsultgeneralaccountsFAE.rdl';

    Caption = 'Consult general accounts (FAE)', Comment = 'FRA="Consultation des comptes généraux (FAE)"';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("BC6_Customer No.");
            ...
            column(G_L_Entry__G_L_Entry___Customer_No__; "G/L Entry"."BC6_Customer No.")
            {
            }
    ...
    var
        ...
        CONSULTATION_OF_GENERAL_ACCOUNTSCaptionLbl: Label 'CONSULTATION OF GENERAL ACCOUNTS (FAE)', Comment = 'FRA="CONSULTATION DES COMPTES GENERAUX (FAE)"';
        ...
        Gtxt_AccountNoFilter: Text;
        Gtxt_SourceNoFilter: Text;
}
