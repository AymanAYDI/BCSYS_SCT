report 50055 "BC6_Ventes : Avoir"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/VentesAvoir.rdl';
        ...
        dataitem("Sales Invoice Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(DocCaptCopyText; Text004)
                    {
                    }
                    ...
                    column(OrderNo_SalesInvHdr; OrderNoText)
                    {
                    }
    ...
    var
        ...
        Text004: Label 'Sales - Invoice %1', Comment = 'FRA="AVOIR"';
