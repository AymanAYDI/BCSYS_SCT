report 50047 "BC6_Facture vente"
{
    // //CREATION JX-AUD DU 24/08/2010 à partir du report 206
    // //FACTURE VENTE GESTION MANDATAIRE
    // 
    ...
    // 
    // //MODIF JX-AUD 21/09/2011
    // //Remontée des adresses ANNONCEUR et MANDATAIRE
    // 
    // //Modif JX-AUD du 08/02/2013
    // //Ajout du champ votre référence
    // 
    // //JX-AUD du 13/05/2013
    // //Agrandissement logo
    // 
    // //JX-AUD du 23/07/2013
    // //Ajouter de la mention "payeur" ou "non payeur" à côté de la mention MANDATAIRE
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/Facturevente.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                IF "Sales Invoice Header"."BC6_Agent" = '' THEN BEGIN
                ...
                END ELSE
                    IF Cust.GET("Sales Invoice Header"."BC6_Agent") THEN BEGIN
                        IF "Sales Invoice Header"."BC6_Paying agent" = TRUE THEN BEGIN
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(IncludeShipmentNoF; IncludeShptNo)
                    {
    ...
    var
        ...
        ShiptoAddrCaptionLbl: Label 'Ship-to Address', Comment = 'FRA="Adresse destinatair"';
        ...
        Text020: Label 'Agent doesn''t exist';
