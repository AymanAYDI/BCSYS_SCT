report 50041 "BC6_Commande achat et contrat"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/Commandeachatetcontrat.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            // column(CtraDes1; Grec_Contract."BC6 Description1")
            // {
            // }
            // column(CtraDes2; Grec_Contract."BC6 Description2")
            // {
            // }
            // column(CtraDes3; Grec_Contract."BC6 Description3")
            // {
            // }
            // column(CtraDes4; Grec_Contract."BC6 Description4")
            // {
            // }
            // column(CtraDes5; Grec_Contract."BC6 Description5")
            // {
            // }
            // column(CtraDes6; Grec_Contract."BC6 Description6")
            // {
            // }
            // column(CtraDes7; Grec_Contract."BC6 Description7")
            // {
            // }
            // column(CtraDes8; Grec_Contract."BC6 Description8")
            // {
            // }
            // column(CtraIntervenant; Grec_Contract."BC6 Speaking supplier")
            // {
            // }
            // column(CtraIntervenantVSCT; Grec_Contract."BC6 Speaking VSCT")
            // {
            // }
            // column(CtraTerms; FORMAT(Grec_Contract."BC6 Term of service") + ' jours-hommes')
            // {
            // }
            // column(CtraDate; 'Du ' + FORMAT(Grec_Contract."BC6 Date of entry") + ' au ' + FORMAT(Grec_Contract."BC6 End date"))
            // {
            // }
            // column(CtraTJM; FORMAT(Grec_Contract."BC6 TJM", 10, 2) + ' euros')
            // {
            // }
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(VendorAddr1; "Purchase Header"."Pay-to Name")
                    {
                    }
                    column(VendorAddr2; "Purchase Header"."Pay-to Address")
                    {
                    }
                    column(VendorAddr3; "Purchase Header"."Pay-to Address 2")
                    {
                    }
                    column(VendorAddr4; "Purchase Header"."Pay-to Post Code")
                    {
                    }
                    column(VendorAddr5; "Purchase Header"."Pay-to City")
                    {
                    }
                    column(VendorAddr6; "Purchase Header"."Buy-from Contact")
                    {
                    }
                    column(VendorAddr7; Gtxt_Tel)
                    {
                    }
                    column(VendorAddr8; Gtxt_Fax)
                    {
                    }
                    ...
                    column(ShipToAddr4; "Purchase Header"."Ship-to Post Code")
                    {
                    }
                    column(ShipToAddr5; "Purchase Header"."Ship-to City")
                    {
                    }
                    ...
                    column(TotalVATText; TotalVATText)
                    {
                    }
                    ...
                    dataitem(RoundLoop; 2000000026)
                    {
                        ...
                        column(VATAmount; LineVatAmount)
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        begin
                            ...
                            LineVatAmount := "Purchase Line"."Amount Including VAT" - "Purchase Line"."Line Amount";
                        end;
                    ...
                    begin
                        ...
                        GTxt_PaymentMethod := '';
                        GRec_PaymentMethod.RESET();
                        IF GRec_PaymentMethod.GET("Purchase Header"."Payment Method Code") THEN
                            GTxt_PaymentMethod := GRec_PaymentMethod.Description;

                        GTxt_PaymentTerms := '';
                        GRec_PaymentTerms.RESET();
                        IF GRec_PaymentTerms.GET("Purchase Header"."Payment Terms Code") THEN
                            GTxt_PaymentTerms := GRec_PaymentTerms.Description;

                        Gtxt_Contact := '';
                        Gtxt_Tel := '';
                        Gtxt_Fax := '';
                        IF Grec_Fournisseur.GET("Purchase Header"."Pay-to Vendor No.") THEN BEGIN
                            Gtxt_Contact := Grec_Fournisseur.Contact;
                            Gtxt_Tel := Grec_Fournisseur."Phone No.";
                            Gtxt_Fax := Grec_Fournisseur."Fax No.";
                        END;

                        IF Grec_CodePays.GET("Purchase Header"."Ship-to Country/Region Code") THEN
                            Gtxt_NomPaysLivr := Grec_CodePays.Name
                        ELSE
                            Gtxt_NomPaysLivr := '';

                        IF Grec_CodePays.GET("Purchase Header"."Pay-to Country/Region Code") THEN
                            Gtxt_NomPaysRèglement := Grec_CodePays.Name
                        ELSE
                            Gtxt_NomPaysRèglement := '';
                    end;
                }
            ...
            // Lrec_ApprovalSetup: Record "Approval Setup";
            begin
                ...
                // Grec_Contract.SETFILTER(Grec_Contract."BC6 Order No.", "Purchase Header"."No.");
                // IF NOT Grec_Contract.FINDFIRST THEN
                //     Grec_Contract.INIT;
            end;
        }
    }
    ...
    labels
    {
        ...
        Title = 'ORDER', Comment = 'FRA="BON DE COMMANDE"';
    ...
    var
        ...
        GRec_PaymentTerms: Record "Payment Terms";
        ...
        RemImplbl: Label 'IMPORTANT :', Comment = 'FRA="IMPORTANT : Prière de reporter le n° de Bon de commande sur la facture, condition préalable au règlement de celle-ci."';
        ...
        Text004: Label 'Order%1', Comment = 'FRA="Order%1"';
        ...
        TotalVATText: Label 'Total TVA', Comment = 'FRA="Total TVA"';
        ...
        Gtxt_Contact: Text[50];
        Gtxt_NomPaysLivr: Text[50];
        "Gtxt_NomPaysRèglement": Text[50];
        GTxt_PaymentMethod: Text[50];
        GTxt_PaymentTerms: Text[50];
