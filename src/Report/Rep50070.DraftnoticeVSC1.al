report 50070 "BC6_Draft notice VSC 1"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/RDLC/DraftnoticeVSC1.rdl';

    Caption = 'Draft notice', Comment = 'FRA="Avis de virement 2015"';
    ...
    dataset
    {
        dataitem("Payment Lines1"; "Payment Line")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem("Payment Line"; "Payment Line")
                {
                    ...
                    dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
                    {
                        ...
                        DataItemTableView = SORTING("Vendor No.", "Applies-to ID", "BC6_Sort Yooz No.");
                        column(Vendor_Ledger_Entry_YoozNo; "BC6_Yooz No.")
                        {
                        }
                        ...
                        begin
                            ...
                            IF "BC6_Yooz No." <> '' THEN BEGIN
                                PaymentLine_G.GET("Payment Line"."No.", "Payment Line"."Line No.");
                                PaymentLine_G."BC6_Applied Yooz No." := PaymentLine_G."BC6_Applied Yooz No." + "BC6_Yooz No." + ';';
                                PaymentLine_G.MODIFY();
                            END;
                        end;
                    ...
                    begin
                        ...
                        IF VendLedgEntry.FINDFIRST() THEN
                            REPEAT
                                IF VendLedgEntry."BC6_Yooz No." <> '' THEN
                                    IF EVALUATE(VendLedgEntry."BC6_Sort Yooz No.", VendLedgEntry."BC6_Yooz No.") THEN
            ...
            begin
                SETRANGE("No.", TransfertNo);
                //
                PaymentLine_G.SETRANGE("No.", TransfertNo);
                PaymentLine_G.MODIFYALL("BC6_Applied Yooz No.", '');
            end;
        }
    }
    ...
    var
        ...
        YoozLbl: Label 'Yooz No.', Comment = 'FRA="N° Yooz"';
        HeaderText1: Text;
        CopyText: Text[30];
        Gtxt_IBAN: Text[30];
